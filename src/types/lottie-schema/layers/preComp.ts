import type { ValueKeyframed } from '../properties/value';
...
export interface RuntimePreCompLayer extends RuntimeBaseLayer {
    /**
     * Type: 图层类型，固定值 LayerTypeEnum.PreComp
